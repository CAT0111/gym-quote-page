...
build/
  ...
  templates/
    (9个 .html 文件, 最新:03-27 13:03)
    base.html.bak-pre3d  (78行, 03-26 12:19)
pkg/
  (5个 .html 文件, 最新:03-29 18:15)
  cpjason77098/
    latest.html  (1762行, 03-29 17:53)
    v1/
      index.html  (1762行, 03-29 17:53)
  my-jason-400m/
    latest.html  (1762行, 03-29 18:15)
    v1/
...
### package (tblkGcwDg5t5U1Lu) — 7个字段, 6条记录
  方案ID                 Text
  客户名                  Text
  包含器材列表               Link
  适用面积m²               Number
