...
PACKAGE = {
    ...
    "total_machines": 55,
    "fob_total_usd": 30000,
    "fob_total_cny": 207300,
    "fob_total_myr": 120000,
    "cif_port_klang_usd": None,
    "fob_location": "Ningjin",
    "ddp_freight_usd": 2500,
    "ddp_freight_cny": 17300,
    "ddp_freight_myr": 10000,
    "ddp_port": "Kuala Lumpur",
    "ddp_port_zh": "吉隆坡",
    "ddp_port_ms": "Kuala Lumpur",
    "ddp_quote_date_en": "Mar 2026",
    "ddp_quote_date_zh": "2026年3月",
    "ddp_quote_date_ms": "Mac 2026",
    "ddp_total_usd": 32500,
    "ddp_total_cny": 224600,
    "ddp_total_myr": 130000,
        ...
        'schedule': [
            {
                ...
                'interval_zh': '每次使用前',
                'interval_ms': 'Sebelum setiap penggunaan',
                'action': 'Check rotary safety lock engagement (SAFETY CRITICAL!)',
                'action_zh': '检查旋转锁扣是否正常锁定（安全关键！）',
                'action_ms': 'Periksa penguncian kunci keselamatan putar (KRITIKAL KESELAMATAN!)',
            },
            {
                'interval': 'Weekly',
                'interval_zh': '每周',
                ...
                'action_ms': 'Lap rel panduan dan sapukan lapisan nipis gris',
            },
            {
                'interval': 'Monthly',
                'interval_zh': '每月',
                ...
                'action_ms': 'Periksa kelancaran putaran pelapik bar',
            },
            {
                'interval': 'Quarterly',
                'interval_zh': '每季度',
                ...
                'action_ms': 'Periksa kehausan galas linear/sesendal',
            },
            {
                'interval': 'Semi-annually',
                'interval_zh': '每半年',
        ...
        'schedule': [
            {
                ...
                'action_ms': 'Periksa kehausan lubang pengunci J-Hook dan lengan keselamatan',
            },
            {
                'interval': 'Quarterly',
                'interval_zh': '每季度',
                ...
                'action_ms': 'Periksa titik kimpalan, ketatkan bolt lantai',
            },
            {
                'interval': 'Annually',
                'interval_zh': '每年',
                'interval_ms': 'Setiap tahun',
                'action': 'Touch up paint (if chipped or rusted)',
                'action_zh': '补漆（如有掉漆或锈蚀）',
                'action_ms': 'Baiki cat (jika tercalar atau berkarat)',
            },
        ],
        ...
        'schedule': [
            {
                ...
                'action_ms': 'Periksa permukaan getah untuk retakan atau terangkat',
            },
            {
                'interval': 'Quarterly',
                'interval_zh': '每季度',
                ...
                'action_zh': '检查木板有无变形',
                'action_ms': 'Periksa papan kayu untuk melengkung',
            },
            {
                'interval': 'Annually',
                'interval_zh': '每年',
                ...
                'action_ms': 'Ganti permukaan getah jika sangat haus (beli tikar getah secara tempatan)',
            },
        ],
        ...
        'schedule': [
            {
                ...
                'action_ms': 'Periksa titik kimpalan dan kestabilan kaki',
            },
            {
                'interval': 'Semi-annually',
                'interval_zh': '每半年',
                ...
                'action_ms': 'Periksa kehausan pad getah penyangga, baiki cat',
            },
        ],
        ...
        'schedule': [
            {
                ...
                'action_zh': '检查焊接点和底脚',
                'action_ms': 'Periksa titik kimpalan dan kaki',
            },
            {
                'interval': 'Semi-annually',
                'interval_zh': '每半年',
                ...
                'action_zh': '检查橡胶垫，补漆',
                'action_ms': 'Periksa pad getah, baiki cat',
            },
        ],
     ...
     "maintenance": {
        ...
        'schedule': [
            ...
            },
            {
                ...
                'action_zh': '掉漆处补漆防锈',
                'action_ms': 'Baiki cat di tempat tercalar untuk mengelak karat',
            },
        ],
        ...
        'schedule': [
            {
                ...
                'action_ms': 'Lap peluh dari upholsteri (peluh adalah musuh utama kulit PU)',
            },
            {
                'interval': 'Monthly',
                'interval_zh': '每月',
                ...
                'action_zh': '检查螺栓紧固和脚垫',
                'action_ms': 'Periksa keketatan bolt dan pad kaki',
            },
            {
                'interval': 'When cracked',
                'interval_zh': '皮面开裂时',
                'interval_ms': 'Apabila retak',
                'action': 'Local sofa reupholstery shop, ~RM50-80 per pad',
                'action_zh': '本地找沙发翻新店重新包皮，约RM50-80/张',
                'action_ms': 'Kedai upholsteri sofa tempatan, ~RM50-80 setiap pad',
            },
        ],
        ...
        'schedule': [
            {
                ...
                'action_zh': '擦拭皮面汗渍',
                'action_ms': 'Lap peluh dari upholsteri',
            },
            {
                'interval': 'Monthly',
                'interval_zh': '每月',
                ...
                'action_ms': 'Periksa kunci pelarasan sudut dan bolt',
            },
        ],
     ...
     "maintenance": {
        ...
        'schedule': [
            ...
            },
            {
                ...
                'action_ms': 'Periksa pemulangan spring pin kunci sudut',
            },
            {
                'interval': 'Monthly',
                'interval_zh': '每月',
     ...
     "maintenance": {
        ...
        'schedule': [
            ...
            },
            {
                ...
                'action_zh': '检查焊接点和螺栓',
                'action_ms': 'Periksa titik kimpalan dan bolt',
            },
        ],
     ...
     "maintenance": {
        ...
        'schedule': [
            ...
            },
            {
                ...
                'action_zh': '检查各角度锁销弹簧',
                'action_ms': 'Periksa semua spring pin kunci sudut',
            },
            {
                'interval': 'Monthly',
                'interval_zh': '每月',
        ...
        'schedule': [
            {
                ...
                'action_zh': '擦拭接触面汗渍',
                'action_ms': 'Lap peluh dari permukaan sentuhan',
            },
            {
                'interval': 'Monthly',
                'interval_zh': '每月',
                ...
                'action_ms': 'Periksa lubang pelarasan ketinggian dan pin kunci',
            },
            {
                'interval': 'Quarterly',
                'interval_zh': '每季度',
        ...
        'schedule': [
            {
                ...
                'action_ms': 'Periksa salutan getah/penyaduran krom untuk mengelupas, ketatkan kepala dumbbell yang longgar',
            },
            {
                'interval': 'Quarterly',
                'interval_zh': '每季度',
                ...
                'action_ms': 'Bersihkan dengan kain lembap, simpan kering',
            },
        ],
        ...
        'schedule': [
            {
                ...
                'action_zh': '检查包胶/电镀层',
                'action_ms': 'Periksa salutan getah/penyaduran krom',
            },
            {
                'interval': 'Quarterly',
                'interval_zh': '每季度',
                ...
                'action_zh': '清洁，紧固螺纹',
                'action_ms': 'Bersihkan, ketatkan ulir',
            },
        ],
        ...
        'schedule': [
            {
                ...
                'action_ms': 'Periksa retakan (plat besi tuang boleh retak dalam kes ekstrem), bersihkan permukaan',
            },
        ],
        ...
        'schedule': [
            {
                ...
                'action_zh': '检查裂纹，清洁表面',
                'action_ms': 'Periksa retakan, bersihkan permukaan',
            },
        ],
        ...
        'schedule': [
            {
                ...
                'action_ms': 'Lap aci bar dengan minyak 3-IN-ONE untuk mengelak karat',
            },
            {
                'interval': 'Monthly',
                'interval_zh': '每月',
                ...
                'action_ms': 'Putar pelapik untuk periksa kelancaran galas',
            },
            {
                'interval': 'Quarterly',
                'interval_zh': '每季度',
                ...
                'action_ms': 'Buka pelapik, bersihkan gris lama, sapukan semula gris galas',
            },
        ],
        ...
        'schedule': [
            {
                ...
                'action_zh': '擦拭杆身防锈',
                'action_ms': 'Lap aci bar untuk mengelak karat',
            },
            {
                'interval': 'Quarterly',
                'interval_zh': '每季度',
                ...
                'action_zh': '套筒清洁注脂',
                'action_ms': 'Bersihkan pelapik, sapukan semula gris',
            },
        ],
        ...
        'schedule': [
            {
                ...
                'action_ms': 'Periksa titik kimpalan pemegang dan salutan serbuk',
            },
            {
                'interval': 'Quarterly',
                'interval_zh': '每季度',
                ...
                'action_zh': '清洁表面，干燥存放',
                'action_ms': 'Bersihkan permukaan, simpan kering',
            },
        ],
        ...
        'schedule': [
            {
                ...
                'action_zh': '检查稳定性和焊接点',
                'action_ms': 'Periksa kestabilan dan titik kimpalan',
            },
        ],
        ...
        'schedule': [
            {
                ...
                'action_ms': 'Periksa kulit untuk retakan atau penyahlamaan',
            },
            {
                'interval': '12-24 months',
                'interval_zh': '12-24个月',
                'interval_ms': '12-24 bulan',
                'action': 'Replace entirely when skin is severely cracked (available locally or from China)',
                'action_zh': '外皮严重开裂时整体更换（本地或中国采购均可）',
                'action_ms': 'Ganti sepenuhnya apabila kulit retak teruk (boleh didapati secara tempatan atau dari China)',
            },
        ],
        ...
        'schedule': [
            {
                ...
                'action_ms': 'Periksa ikatan hujung tali untuk kelonggaran',
            },
            {
                'interval': 'Quarterly',
                'interval_zh': '每季度',
                ...
                'action_ms': 'Periksa keketatan bolt sauh dinding',
            },
            {
                'interval': '12-18 months',
                'interval_zh': '12-18个月',
                'interval_ms': '12-18 bulan',
                'action': 'Replace entire rope when frayed (available locally)',
                'action_zh': '绳体磨损起毛时整体更换（本地采购即可）',
                'action_ms': 'Ganti keseluruhan tali apabila berbulu (boleh dibeli secara tempatan)',
            },
        ],
        ...
        'schedule': [
            {
                ...
                'action_ms': 'Periksa jahitan untuk kelonggaran, tali anyaman untuk kehausan',
            },
            {
                'interval': 'Quarterly',
                'interval_zh': '每季度',
                ...
                'action_ms': 'Periksa bolt sauh siling dan karabiner',
            },
            {
                'interval': '12-18 months',
                'interval_zh': '12-18个月',
                ...
                'action_ms': 'Ganti sepenuhnya apabila tali anyaman haus atau jahitan longgar',
            },
        ],
        ...
        'schedule': [
            {
                ...
                'action_ms': 'Periksa retakan, kehilangan keanjalan',
            },
            {
                'interval': '6-12 months',
                'interval_zh': '6-12个月',
                'interval_ms': '6-12 bulan',
                'action': 'Replace entire set when elasticity drops noticeably or cracks appear',
                'action_zh': '弹性明显下降或出现裂纹时整套更换',
                'action_ms': 'Ganti keseluruhan set apabila keanjalan menurun ketara atau retakan muncul',
            },
        ],
        ...
        'schedule': [
            {
                ...
                'action_ms': 'Semburkan disinfektan dan lap selepas penggunaan (peluh + bakteria adalah pembunuh utama tikar)',
            },
            {
                'interval': '12-18 months',
                'interval_zh': '12-18个月',
                ...
                'action_ms': 'Ganti apabila permukaan retak atau bau tidak boleh dihilangkan',
            },
        ],
        ...
        'schedule': [
            {
                ...
                'action_zh': '检查有无塌陷变形',
                'action_ms': 'Periksa kerosakan atau perubahan bentuk',
            },
            {
                'interval': '12-18 months',
                'interval_zh': '12-18个月',
                ...
                'action_ms': 'Ganti apabila daya lantunan menurun ketara',
            },
        ],
        ...
        'schedule': [
            {
                ...
                'action_ms': 'Periksa pinggir dan integriti permukaan anti-gelincir',
            },
            {
                'interval': '12-18 months',
                'interval_zh': '12-18个月',
                ...
                'action_ms': 'Sapukan semula permukaan anti-gelincir apabila haus (beli pita kertas pasir anti-gelincir di kedai perkakasan tempatan)',
            },
        ],
        ...
        'schedule': [
            {
                ...
                'action_ms': 'Periksa bolt dinding untuk kelonggaran (KRITIKAL KESELAMATAN!)',
            },
            {
                'interval': 'Quarterly',
                'interval_zh': '每季度',
            ...
            },
            {
                'interval': '12 months',
                'interval_zh': '12个月',
                'interval_ms': '12 bulan',
                'action': 'Replace grip cover when worn',
                'action_zh': '握把套磨损时更换',
                'action_ms': 'Ganti sarung genggaman apabila haus',
            },
        ],
        ...
        'schedule': [
            {
                ...
                'action_zh': '清扫灰尘，湿拖清洁',
                'action_ms': 'Sapu habuk, mop basah bersihkan',
            },
            {
                'interval': 'Monthly',
                'interval_zh': '每月',
                ...
                'action_zh': '检查拼接缝有无翘起',
                'action_ms': 'Periksa sambungan saling kunci untuk terangkat',
            },
            {
                'interval': 'Annually',
                'interval_zh': '每年',
                ...
                'action_ms': 'Ganti jubin rosak secara individu (disyorkan beli 5% lebihan semasa pembukaan sebagai alat ganti)',
            },
        ],
        ...
        'schedule': [
            {
                ...
                'action_ms': 'Periksa kawasan deadlift/squat untuk lekukan atau retakan',
            },
            {
                'interval': 'Annually',
                'interval_zh': '每年',
                ...
                'action_ms': 'Ganti bahagian rosak teruk secara individu',
            },
        ],
        ...
        'schedule': [
            {
                ...
                'action_ms': 'Bersihkan cap jari dan peluh dengan pencuci kaca',
            },
            {
                'interval': 'Monthly',
                'interval_zh': '每月',
                ...
                'action_ms': 'Periksa pemasangan sudut untuk kelonggaran',
            },
        ],
        ...
        'schedule': [
            {
                ...
                'action_zh': '检查门铰和锁具',
                'action_ms': 'Periksa engsel pintu dan kunci',
            },
            {
                'interval': 'Quarterly',
                'interval_zh': '每季度',
                ...
                'action_ms': 'Sapukan sedikit pelincir pada engsel untuk mengelak karat (kelembapan tinggi di Malaysia)',
            },
        ],
